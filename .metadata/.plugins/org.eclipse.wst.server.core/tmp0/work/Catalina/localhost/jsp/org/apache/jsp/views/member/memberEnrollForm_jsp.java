 ...
 * Generated at: 2021-04-14 04:46:57 UTC
...
public final class memberEnrollForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/member/../common/menubar.jsp", Long.valueOf(1618206858355L));
  }
 ...
 if(loginUser == null){ 
      ...
      out.write("\t\t\t// form 요소 안에 name이 userId인 input요소객체 선택하기\r\n");
      out.write("\t\t\tvar $userId = $(\"#enrollForm input[name=userId]\"); // value값 아님 이후에 userId.val()로 알아내면 됨\r\n");
      out.write("\t\t\t// 이거 jQuery 방식으로 입력한 객체인 것을 알려주기 위해 $ 붙이기\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      ...
      out.write("\t\t\t\t\tif(result == 'NNNNN'){ // 사용불가능(기존에 아이디가 있음)\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\talert(\"이미 존재하거나 탈퇴한 회원의 아이디입니다.\")\r\n");
      out.write("\t\t\t\t\t\t$userId.focus();\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t} else{ // 사용가능(아이디 생성 가능)\r\n");
      out.write("\t\t\t\t\t\tif(confirm(\"사용가능한 아이디입니다. 정말로 사용하시겠습니까?\")){\r\n");
      out.write("\t\t\t\t\t\t\t// 사용하겠다 => 더 이상 변경불가, 회원가입버튼활성화\r\n");
      out.write("\t\t\t\t\t\t\t$userId.attr(\"readonly\", true);\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#enrollForm :submit\").removeAttr(\"disabled\");\r\n");
      out.write("\t\t\t\t\t\t\t// id가 enrollForm인 자식요소들 중  submit 요소의 속성(disabled)을 제거하겠다\r\n");
      out.write("\t\t\t\t\t\t} else{\r\n");
      out.write("\t\t\t\t\t\t\t// 사용가능하지만 다시 입력하겠다\r\n");
      out.write("\t\t\t\t\t\t\t$userId.focus();\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}, \r\n");
      out.write("\t\t\t\terror: function(){\r\n");
      out.write("\t\t\t\t\tconsole.log(\"아이디 중복체크용  ajax 통신실패\")\t\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t});\r\n");
