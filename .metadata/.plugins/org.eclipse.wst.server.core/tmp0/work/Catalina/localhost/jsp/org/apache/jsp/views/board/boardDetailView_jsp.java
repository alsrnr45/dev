 ...
 * Generated at: 2021-04-15 04:43:18 UTC
...
if(loginUser == null){ 
      ...
      out.write("                        <td><button onclick=\"addReply();\">댓글등록</button></td>\r\n");
      out.write("                        ");
 } 
      out.write("\r\n");
      out.write("                    </tr>\r\n");
      ...
      out.write("    \t\r\n");
      out.write("    \t\r\n");
      out.write("    \t// 게시글의 댓글리스트를 조회해오는 함수\r\n");
      out.write("    \t$(function(){\r\n");
      out.write("    \t\tselectReplyList();\r\n");
      out.write("    \t\t\r\n");
      out.write("    \t\tsetInterval(selectReplyList , 10000);\r\n");
      out.write("    \t\t// 1초단위마다 매번 실행할 함수\r\n");
      out.write("    \t\t\r\n");
      out.write("    \t\t\r\n");
      out.write("    \t})\r\n");
      out.write("    \t\r\n");
      ...
      out.write("    \t\r\n");
      out.write("    \t// 요청시 회원번호는 넘기지 않을거임! 서블릿에서 작업할거임\r\n");
      ...
      out.write("    \t\t\ttype: \"post\",\r\n");
      out.write("    \t\t\tdata: {\r\n");
      out.write("    \t\t\t\tcontent:$(\"#replyContent\").val(), // content라는 key값으로 id가 replyContent인 값을 넘기겠다.\r\n");
      out.write("    \t\t\t\tbno:");
      out.print(b.getBoardNo());
      out.write(" // bno라는 key값으로 board객체에 BoardNo값을 가져오겠다.\r\n");
      out.write("    \t\t\t\t");
      out.write(" \r\n");
      out.write("    \t\t\t},\r\n");
      out.write("    \t\t\tsuccess:function(result){\r\n");
      out.write("    \t\t\t\tif(result > 0){\r\n");
      out.write("    \t\t\t\t\t// 댓글 성공하면 내가 쓴 댓글이 최상단에 붙여지기 (갱신된 리스트 다시 조회해서 뿌려줘야함)\r\n");
      out.write("    \t\t\t\t\tselectReplyList();\r\n");
      out.write("    \t\t\t\t\t// 깔끔하게 입력했던 textarea의 내용도 비워줘야 함 => replyContent에 \"\"로 깔끔하게 비워줌\r\n");
      ...
      out.write("    \t}\r\n");
      out.write("    \t\r\n");
      out.write("    \t// 해당  게시글에 딸린 댓글리스트 조회용 ajax\r\n");
