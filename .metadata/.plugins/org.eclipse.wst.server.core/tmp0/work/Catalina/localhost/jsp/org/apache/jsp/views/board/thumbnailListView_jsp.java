 ...
 * Generated at: 2021-04-13 05:22:36 UTC
...
public final class thumbnailListView_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser != null ){ 
      ...
      out.write("            <a href=\"");
      out.print(contextPath);
      out.write("/enrollForm.th\" class=\"btn btn-secondary btn-sm\">글 작성</a>\r\n");
      out.write("            <br><br>\r\n");
      out.write("        </div>\r\n");
      out.write("        ");
 } 
 ...
 for(Board b : list){ 
      ...
      out.write("\" alt=\"\" width=\"200\" height=\"150\">\r\n");
      out.write("                <p>\r\n");
      out.write("                    No.");
      out.print( b.getBoardNo() );
      out.write(" 게시글 제목 : ");
      ...
      out.write("\t\t\t\t\t// bno = 게시글번호를 받아와야하는 방법은 input hidden요소를 이용해서 하나의 b.getBoardNo()의 값을 받아와야 함 \r\n");
      out.write("\t\t\t\t\t// 지금 선택한 요소 값 지정 => $(this) 그 요소의 자손 중 첫번째 자손의 val(값)을 호출하겠다.\r\n");
      out.write("\t\t\t\t})\r\n");
      out.write("\t\t\t})\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t</script>\r\n");
