 ...
 * Generated at: 2021-04-12 15:21:30 UTC
...
public final class boardUpdateForm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null){ 
      ...
      out.write("        <form action=\"");
      out.print( contextPath );
      out.write("/update.bo\" id=\"updateForm\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
      ...
      out.write("                        <script>\r\n");
      out.write("                        $(function(){\r\n");
      out.write("                        \t// option요소들에 순차적으로 접근하면서 그 때의 text값들을 해당 이 게시글의 카테고리명과 비교\r\n");
      out.write("                        \t// 일치할 경우 그 때의 option요소에 selected 속성 부여\r\n");
      out.write("                        \t$(\"#updateForm option\").each(function(){\r\n");
      out.write("                        \t\tif($(this).text() == \"");
      out.print( b.getCategoryNo() );
      out.write("\"){\r\n");
      out.write("                        \t\t\t$(this).attr(\"selected\", true);\r\n");
      out.write("                        \t\t} // 현재 내가 가리키고 있는 option에 접근한다 = $(this).text()\r\n");
      out.write("                        \t})\r\n");
      out.write("                        })\r\n");
      out.write("                        </script>\r\n");
      out.write("                    </td>\r\n");
      ...
      out.write("                    <th>내용</th>\r\n");
      out.write("                    <td>\r\n");
      out.write("                        <textarea name=\"content\" rows=\"10\" style=\"resize:none\" value=\"");
 ...
 if(at != null){ 
      ...
      out.write(" <!-- 수정 전, 기존에 올라가 있던 파일이름 -->\r\n");
